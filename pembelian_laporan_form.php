...
<head>
  ...
  <title>Pembelian Laporan Form</title>
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Pembelian Laporan Form</li>
            </ol>
          </nav>
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Pembelian Laporan</h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <form method="POST" action="pembelian_laporan_process.php">
                <!-- Hidden ID for Update -->
                <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
                <!-- End of Hidden ID for Update -->
                <div class="form-group">
                    <label for="tanggal_awal">Tanggal Awal</label>
                    <input type="text" class="form-control form-control-user" id="tanggal_awal" name="tanggal_awal" required>
                    <small>tahun-bulan-tanggal</small>
                </div>
                <div class="form-group">
                    <label for="tanggal_akhir">Tanggal Akhir</label>
                    <input type="text" class="form-control form-control-user" id="tanggal_akhir" name="tanggal_akhir" required>
                    <small>tahun-bulan-tanggal</small>
                </div>
                <div class="form-group">
