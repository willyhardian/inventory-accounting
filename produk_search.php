...
$table = <<<EOT
 (
    SELECT
      produk.id,
      concat_ws(' ',item.nama, jenis.nama, standard.nama, tipe.nama, merek.nama, kategori.nama, warna.nama, concat('dia. ',produk.diameter, ' ',produk.satuan_diameter), concat('@', produk.panjang, produk.satuan_panjang, '/', satuan.nama)) as produk_nama,
      produk.harga,
      jenis.nama AS jenis,
      warna.nama AS warna,
