              ...
              */
              ...
              if($num > 0)
              {
                while($row = mysqli_fetch_array($query))
                {
                  ...
                  /*
                  $sales_quotation_harga_jual = $row['sales_quotation_harga_jual'];
                  ...
                  */
                  ...
                  ?>
                    <tr>
                        ...
                        <td>
                          <?php 
                            //echo $row['item_nama'] . ' ' . $row['jenis_nama'] . ' ' . $row['warna_nama'] . ' ' . $row['kategori_nama'] . ' ' . $row['merek_nama'] . ' dia. ' . $row['produk_diameter'] . '" @' . $row['produk_panjang'] . 'cm/' . $row['satuan_nama']; 
                            echo $row['produk_nama'];
                          ?>
                        </td>
                        <td colspan="2" align="center"><?php echo $row['delivery_order_detail_qty']; ?></td>
              ...
              {
                echo "<tr><td colspan='5'>Hasil tidak ada</td></tr>";
              }
            ?>
            <tr>
