    ...
    <body>
        ...
        <table class="table mx-auto">
          ...
          <tbody>
            ...
            <?php
              /* pembelian section */
              $sql = "SELECT invoice.id AS 'invoice_id', sales_quotation.pajak AS 'sales_quotation_pajak', pelanggan.nama AS 'pelanggan_nama', pelanggan_info.nama_org AS 'pelanggan_info_nama_org', sales_quotation.termin AS 'sales_quotation_termin' FROM invoice INNER JOIN vendor ON pembelian.vendor_id = vendor.id WHERE pembelian.vendor_id = $vendor_id AND pembelian.termin > 0 ORDER BY pembelian.tanggal";
