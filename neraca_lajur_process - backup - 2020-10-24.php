...
<?php include "config.php";
  ...
  <html lang="en">
    ...
    <body>
        ...
        <h2 class="text-center">Neraca Lajur</h2>
                    ...
                    if($row['pembelian_status_pembayaran_status'] == 'bayar')
                    {
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          $kode_akun_1102 = $kode_akun_1102 + ($row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_pembelian / 100)) - floatval($diskon_pembelian)) * ($row_total_harga['down_payment'] / 100);
                          ?>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php
                            ...
                            $kode_akun_1102 = $kode_akun_1102 + $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_pembelian / 100))) - $diskon_pembelian;
                          ?>
                        </td>
                        <td><?php echo "Rp ". number_format($kode_akun_1102_debet - $kode_akun_1102_kredit, 0, ",", "."); ?></td>
                        <td></td>
                  ...
                  if($row['invoice_status_pembayaran_status'] == 'bayar')
                  {
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        $kode_akun_1102 = $kode_akun_1102 + ($row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_sales_quotation / 100)) - floatval($diskon_sales_quotation)) * ($row_total_harga['down_payment'] / 100);
                        ?>
                      </td>
                      <td>-</td>
                      <td><?php echo "Rp " . number_format($kode_akun_1102_debet - $kode_akun_1102_kredit, 0, ",", "."); ?></td>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php
                            ...
                            $kode_akun_1102 = $kode_akun_1102 + ($row_total_harga['total_harga'] - (($row_total_harga['total_harga'] * ($pajak_sales_quotation / 100)) + $diskon_sales_quotation));
                          ?>
                        </td>
                        <td>
                          -
        ...
        <table class="table mx-auto">
          <thead>
            ...
            <tr>
              <th style="height: 50px;">Debit</th>
              <th style="height: 50px;">Kredit</th>
              <th style="height: 50px;">Debit</th>
              <th style="height: 50px;">Kredit</th>
              <th style="height: 50px;">Debit</th>
              <th style="height: 50px;">Kredit</th>
            ...
            <tr>
              ...
              <?php
                if($debet_labarugi > $kredit_labarugi)
                {
                  ...
                  echo "<td></td>";
                  echo "<td><strong>" . "Rp " . number_format($hasil_labarugi, 0, ",", ".") . "</strong></td>";
                }
                else
                {
              ...
              <?php
                if($debet_neraca > $kredit_neraca)
                {
                  ...
                  echo "<td></td>";
                  echo "<td><strong>" . "Rp " . number_format($hasil_neraca, 0, ",", ".") . "</strong></td>";
                }
                else
                {
  ...
  $dompdf->stream("neraca_lajur.pdf");
