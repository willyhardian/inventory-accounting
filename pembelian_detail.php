        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Pembelian Detail</li>
            </ol>
          </nav>
          <!-- Page Heading -->
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              {
              ?>
              <a href="pembelian_detail_form.php?pembelian_id=<?php echo $pembelian_id; ?>&action=add" class="btn btn-info mb-3">ADD</a>
              <?php
              }
              ?>
              <br>
              <small>Aktif = Barang belum diterima, Selesai = barang sudah diterima</small>
              <ul class="nav nav-tabs mb-3">
                <li class="nav-item">
                  <a class="nav-link active" href="pembelian_detail.php?pembelian_id=<?php echo $pembelian_id; ?>">Pembelian Detail Aktif</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pembelian_detail_selesai.php?pembelian_id=<?php echo $pembelian_id; ?>">Pembelian Detail Selesai</a>
                </li>
              </ul>
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result))
                    {
                      ...
                      <tr>
                        ...
                        <td><?php echo "Rp " . number_format($row['pembelian_detail_harga_beli'], 0, ",", "."); ?></td>
