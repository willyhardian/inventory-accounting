          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <ul class="nav nav-tabs mb-3">
                <li class="nav-item">
                  <a class="nav-link" href="sales_quotation_detail.php?sales_quotation_id=<?php echo $sales_quotation_id; ?>">Sales Quotation Detail Aktif</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="sales_quotation_detail_selesai.php?sales_quotation_id=<?php echo $sales_quotation_id; ?>">Sales Quotation Detail Selesai</a>
                </li>
              </ul>
