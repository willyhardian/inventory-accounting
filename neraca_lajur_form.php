      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Neraca Lajur</h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <form method="POST" action="neraca_lajur_process.php">
                <!-- Hidden ID for Update -->
                <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
                <!-- End of Hidden ID for Update -->
                <div class="form-group">
                    <label for="bulan_patokan">Pilih bulan</label>
                    <input type="text" class="form-control form-control-user monthPicker" autocomplete="off" id="bulan_patokan" name="bulan_patokan" required>
                    <small>tahun-bulan (Contoh: 2020-12)</small>
                </div>
                <div class="form-group">
