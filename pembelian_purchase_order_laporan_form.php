        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">PO Pembelian</li>
            </ol>
          </nav>
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">PO Pembelian</h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <form method="POST" action="pembelian_purchase_order_laporan_process.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user" id="tanggal_dibuat" name="tanggal_dibuat" autocomplete="off" required>
                    <small>tahun-bulan-tanggal</small>
                </div>
                <div class="form-group">
                    <label for="penerima">Nama Purchasing</label>
                    <input type="text" class="form-control form-control-user" id="purchasing" name="purchasing" required>
                </div>
                <div class="form-group">
