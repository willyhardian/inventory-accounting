        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <form method="POST" action="inventory_laporan_process.php">
                <!-- Hidden ID for Update -->
                <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
                <!-- End of Hidden ID for Update -->
                <div class="form-group">
                    <label for="tanggal_awal">Tanggal Awal</label>
                    <input type="text" class="form-control form-control-user" id="tanggal_awal" name="tanggal_awal" autocomplete="off" required>
                    <small>tahun-bulan-tanggal</small>
                </div>
                <div class="form-group">
                    <label for="tanggal_akhir">Tanggal Akhir</label>
                    <input type="text" class="form-control form-control-user" id="tanggal_akhir" name="tanggal_akhir" autocomplete="off" required>
                    <small>tahun-bulan-tanggal</small>
                </div>
                <div class="form-group">
