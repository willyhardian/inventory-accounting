    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-12">
              <a href="warna_form.php?action=add" class="btn btn-info mb-3">ADD</a>
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="warna_form.php?id=<?php echo $row['id']; ?>&action=edit" class="mr-3"><i class="fas fa-edit"></i></a>
                          <a href="warna_form.php?id=<?php echo $row['id']; ?>&action=delete"><i class="fas fa-trash"></i></a>
                        </td>
                      </tr>
                      <?php
                    }
