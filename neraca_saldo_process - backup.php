                    ...
                    <tr>
                      ...
                      <td>
                        <?php
                          ...
                          array_push($kode_akun_5101_debet, $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_pembelian / 100)) - floatval($diskon_pembelian));
                      ...
                      <?php
                        ...
                        if($row_check_dp['down_payment'] == 0)
                        {
                          ...
                          <td>
                            <?php
                                echo $row['vendor_nama'];
                                $keterangan_1102 = $row['vendor_nama'];
                            ?>
                          </td>
                          <td>-</td>
                          <td>
                            <?php
                              ...
                              array_push($kode_akun_1102_kredit, $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_pembelian / 100)) - floatval($diskon_pembelian));
                              echo "Rp " . number_format($row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_pembelian / 100)) - floatval($diskon_pembelian), 0, ",", ".");
                            ?>
                            <?php //echo $row['harga_beban']; ?>
                          </td>
                        ...
                        else
                        {
                          ...
                          <td>
                            <?php
                              ...
                              array_push($kredit, $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_pembelian / 100)) - floatval($diskon_pembelian));
                              array_push($kode_akun_2101_kredit, $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_pembelian / 100)) - floatval($diskon_pembelian));
                              echo "Rp " . number_format($row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_pembelian / 100)) - floatval($diskon_pembelian), 0, ",", ".");
                            ?>
                            <?php //echo $row['harga_beban']; ?>
                          </td>
                ...
                while($row = mysqli_fetch_array($query))
                {
                  ...
                  else
                  {
                    ...
                    <tr>
                      ...
                      <td>
                        <?php
                          ...
                          array_push($kode_akun_4101_debet, $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_sales_quotation / 100)) - floatval($diskon_sales_quotation));
                    ...
                    <tr>
                      ...
                      <td><?php echo "PJ" . $row['id_invoice']; ?></td>
                      <?php
                        $sql_check_dp = "SELECT perform_invoice.down_payment AS 'down_payment' FROM perform_invoice WHERE perform_invoice.id = $id_invoice";
                        $query_check_dp = mysqli_query($conn, $sql_check_dp);
                        $row_check_dp = mysqli_fetch_array($query_check_dp);
                        if($row_check_dp['down_payment'] == 0)
                        {
                          ...
                          <td>
                            <?php
                              ...
                              array_push($kode_akun_1102_kredit, $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_sales_quotation / 100)) - floatval($diskon_sales_quotation));
                              echo "Rp " . number_format($row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_sales_quotation / 100)) - floatval($diskon_sales_quotation), 0, ",", ".");
                            ?>
                            <?php //echo $row['harga_beban']; ?>
                          </td>
                        ...
                        else
                        {
                          ...
                          <td>
                            <?php
                              $sql_total_harga = "SELECT SUM(sales_quotation_detail.harga_jual * pembelian_detail.qty) AS 'total_harga' FROM invoice_status_pembayaran INNER JOIN invoice ON invoice_status_pembayaran.invoice_id = invoice.id INNER JOIN perform_invoice ON invoice.perform_invoice_id = perform_invoice.id INNER JOIN sales_quotation ON perform_invoice.sales_quotation_id = sales_quotation.id LEFT JOIN pelanggan ON sales_quotation.pelanggan_id = pelanggan.id INNER JOIN produk ON sales_quotation_detail.produk_id = produk.id WHERE sales_quotation_detail.sales_quotation_id = '$id_sales_quotation' AND invoice_status_pembayaran.status = 'aktif' AND invoice_status_pembayaran.tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
                              $query_total_harga = mysqli_query($conn, $sql_total_harga);
                              $row_total_harga = mysqli_fetch_array($query_total_harga);
                              $pajak_sales_quotation = $row['pajak_sales_quotation'];

                              $sql_total_diskon = "SELECT SUM((sales_quotation_detail.harga_jual *  sales_quotation_detail.qty) * (pembelian_detail.diskon / 100)) AS 'total_diskon' FROM sales_quotation_detail INNER JOIN invoice ON invoice.id = sales_quotation_detail.invoice_id INNER JOIN produk ON sales_quotation_detail.produk_id = produk.id INNER JOIN invoice_status_pembayaran ON invoice.id = invoice_status_pembayaran.invoice_id WHERE sales_quotation_detail.sales_quotation_id = '$id_sales_quotation' AND invoice_status_pembayaran.status = 'aktif' AND invoice_status_pembayaran.tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
                              $query_total_diskon = mysqli_query($conn, $sql_total_diskon);
                              $row_total_diskon = mysqli_fetch_array($query_total_diskon);
                              $diskon_sales_quotation = $row_total_diskon['total_diskon'];

                              array_push($kredit, $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_sales_quotation / 100)) - floatval($diskon_sales_quotation));
                              array_push($kode_akun_1111_kredit, $row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_sales_quotation / 100)) - floatval($diskon_sales_quotation));
                              echo "Rp " . number_format($row_total_harga['total_harga'] + ($row_total_harga['total_harga'] * ($pajak_sales_quotation / 100)) - floatval($diskon_sales_quotation), 0, ",", ".");
                            ?>
                            <?php //echo $row['harga_beban']; ?>
                          </td>
