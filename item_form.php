        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <form method="POST" action="item_process.php?action=<?php echo $_GET['action']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user" id="nama" name="nama" value="<?php echo $nama_item; ?>" required <?php echo $readonly; ?>>
                </div>
                <div class="form-group">
                  <label for="keterangan">Keterangan</label>
                  <textarea class="form-control" name="keterangan" id="keterangan" name="keterangan" rows="5" <?php echo $readonly; ?>><?php echo $keterangan_item; ?></textarea>
                </div>
                <div class="form-group">
