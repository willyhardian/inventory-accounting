    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-12">
              <a href="item_form.php?action=add" class="btn btn-info mb-3">ADD</a>
  ...
  <script>
      $(document).ready(function (){
        ...
        var table = $('#table-show').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "item_search.php",
            order: [[0, 'asc']],
            columnDefs: [{
                orderable: false,
                targets: -1,
                render: function(data, type, row){
                  var btn = '<a href="item_form.php?id='+row[0]+'&action=edit" class="mr-3"><i class="fas fa-edit"></i></a><a href="item_form.php?id='+row[0]+'&action=delete"><i class="fas fa-trash"></i></a>';
                  return btn;
                }
             }]
        });
