...
<?php include "config.php";
  $bulan_patokan = $_POST['bulan_patokan'];
  $bulan_patokan_awal = $bulan_patokan . "-1";

  // Converting string to date
  $bulan_patokan_date = strtotime($bulan_patokan);

  // Last date of current month.
  $bulan_patokan_lastdate = strtotime(date("Y-m-t", $bulan_patokan_date ));

  // Day of the last date
  $bulan_patokan_lastdate = date("d", $bulan_patokan_lastdate);

  $bulan_patokan_akhir = $bulan_patokan . "-" . $bulan_patokan_lastdate;
  $tanggal_awal = $bulan_patokan_awal;
  $tanggal_akhir = $bulan_patokan_akhir;
