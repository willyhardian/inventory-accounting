    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-12">
              <a href="standard_form.php?action=add" class="btn btn-info mb-3">ADD</a>
            ...
            var table = $('#table-show').DataTable({
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, row){
                      var btn = '<a href="standard_form.php?id='+row[0]+'&action=edit" class="mr-3"><i class="fas fa-edit"></i></a><a href="standard_form.php?id='+row[0]+'&action=delete"><i class="fas fa-trash"></i></a>';
                      return btn;
                    }
                 }]
            });
