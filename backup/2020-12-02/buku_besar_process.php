  ...
  <html lang="en">
    ...
    <body>
        ...
        <table class="table mx-auto mb-2">
            ...
            <tbody>
              ...
              <?php
                ...
                echo $profil_perusahaan_tanggal;
                echo "<br>";
                echo $tanggal_awal_create_date;
                $query = mysqli_query($conn, $sql);
                $num = mysqli_num_rows($query);
                if($num > 0)
                {
        ...
        <?php
          ...
          $kode_akun_1102_debet += $kode_akun_1102_saldo_awal;
          echo "<h1>" . $kode_akun_1102_debet . "</h1>";
        ?>
        ...
        <?php
          ...
          echo "<h1>" . $kode_akun_1111_debet . "</h1>";
        ?>
                    ...
                    <?php
                      if($row['pajak_pembelian'] > 0)
                      {
                        ...
                        <tr>
                          ...
                          <td>-</td>
                          <td><?php echo "Rp " . number_format($kode_akun_2104_debet - $kode_akun_2104_kredit, 0, ",", "."); ?></td>
                          <td>-</td>
                        </tr>
                        <?php
                      }
                  ...
                  if($row['invoice_status_pembayaran_status'] == 'lunas')
                  {
                    if($row['pajak_sales_quotation'] > 0)
                    {
                      ...
                      <tr>
                        ...
                        <td>-</td>
                        <td><?php echo "Rp " . number_format($kode_akun_2105_debet - $kode_akun_2105_kredit, 0, ",", "."); ?></td>
                        <td>-</td>
                      </tr>
                      <?php
                    }
                        ...
                        if($row['pajak_sales_quotation'] > 0)
                        {
                          ...
                          if($row_total_diskon['total_diskon'] > 0)
                          {
                            ...
                            <tr>
                              ...
                              <td>-</td>
                              <td><?php echo "Rp " . number_format($kode_akun_4102_debet - $kode_akun_4102_kredit, 0, ",", "."); ?></td>
                              <td>-</td>
                            </tr>
                            <?php
                          }
                    ...
                    if($row['pembelian_status_pembayaran_status'] == 'lunas')
                    {
                      ...
                      if($row_total_diskon['total_diskon'] > 0)
                      {
                        ...
                        <tr>
                          ...
                          <td>-</td>
                          <td><?php echo "Rp " . number_format($kode_akun_5102_kredit - $kode_akun_5102_debet, 0, ",", "."); ?></td>
                        </tr>
                        <?php
                      }
                    }
