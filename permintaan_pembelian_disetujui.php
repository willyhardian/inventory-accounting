          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <ul class="nav nav-tabs mb-3">
                <li class="nav-item">
                  <a class="nav-link" href="permintaan_pembelian.php">Aktif</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="permintaan_pembelian_disetujui.php">Disetujui</a>
                </li>
              </ul>
              <table class="table table-striped table-bordered table-first-column-small" id="table-show">
                ...
                <tbody>
                <?php
                  $sql = "SELECT permintaan_pembelian.id AS 'permintaan_pembelian_id', permintaan_pembelian.invoice_id AS 'invoice_id', permintaan_pembelian.tanggal AS 'permintaan_pembelian_tanggal', permintaan_pembelian.produk_id AS 'permintaan_pembelian_produk_id', produk.nama AS 'produk_nama', permintaan_pembelian.qty AS 'permintaan_pembelian_qty' FROM permintaan_pembelian INNER JOIN produk ON permintaan_pembelian.produk_id = produk.id WHERE permintaan_pembelian.status = 'disetujui'";
